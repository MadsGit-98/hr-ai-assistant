...
- **Candidate**: Represents a job applicant with attributes including Name, Overall Score, Categorization, Quality Grade, AI Justification Summary, and Shortlist status
...
- **SC-002**: Users can apply filters and see updated results within 2 seconds for datasets up to 500 candidates
- **SC-003**: 95% of hiring managers can successfully shortlist candidates without requiring assistance
- **SC-004**: The candidate report page loads completely within 5 seconds for datasets up to 500 candidates
